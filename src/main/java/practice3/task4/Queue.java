...
public class Queue implements Observer<File>, ObservableOnSubscribe<File> {
    private final int LENGTH_QUEUE;
    private final ArrayList<File> fileDataArrayList;

    public Queue(int LENGTH_QUEUE) {
    ...
    @Override
    public void onNext(@NonNull File fileData) {
